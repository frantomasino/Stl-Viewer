...
const products = [
  {
    ...
    description: "Set educativo impreso en 3D, ideal para prácticas universitarias y enseñanza de biología.",
    image: "/img/Celulas.jpg",
    link: "https://wa.me/5492346300627?text=Hola%20quiero%20consultar%20por%20el%20Kit%20de%20Células", // 👈 WhatsApp o email
  },
  {
    title: "Maqueta anatómica básica",
    description: "Modelo anatómico para prácticas médicas y educativas, diseñado en base a imágenes reales.",
  ...
  },
  {
    ...
    description: "Modelo 3D hecho a partir de imágenes del paciente. Ideal para planificación quirúrgica.",
    ...
    <section id="productos" className="py-24 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-3xl md:text-4xl font-bold">Productos</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Descubrí nuestra línea de productos 3D educativos y médicos. Consultanos para recibir más información o una cotización personalizada.
          </p>
        </div>
        ...
        <div className="hidden lg:grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {products.map((p, i) => (
            <Card key={i} className="group overflow-hidden border-0 bg-background hover:shadow-lg transition-all duration-300 flex flex-col h-full">
        ...
        <div className="lg:hidden">
          <Carousel opts={{ align: "start", loop: true }} className="w-full" aria-label="Carrusel de productos">
